...
{
    internal class ManageFoodItems
    {
        string itemName;
        int itemId;
       
        // ADD ITEM
        public void AddItemToTheFoodItems()
        {
            FileStream fileStreamObj = new FileStream(@"C:\Users\Boss\Desktop\New folder\fooditem.txt", FileMode.Append, FileAccess.Write);
            StreamWriter swObj = new StreamWriter(fileStreamObj);
            int counter = 1, totalItem;
            Console.WriteLine("Enter total number Of Food Item you want to add in the Food Item");
        ...
        {
            FileStream fileStreamObj = new FileStream(@"C:\Users\Boss\Desktop\New folder\fooditem.txt", FileMode.Open, FileAccess.Read);
            StreamReader streamReaderObj = new StreamReader(fileStreamObj);

            FileStream fileStreamWObj = new FileStream(@"C:\Users\Boss\Desktop\New folder\fooditem.txt", FileMode.Append, FileAccess.Write);
            ...
            File.Move(@"C:\Users\Boss\Desktop\console\ConsoleApp\LibraryManagment\LibraryManagment", @"C:\Users\Boss\Desktop\New folder\fooditem.txt");
