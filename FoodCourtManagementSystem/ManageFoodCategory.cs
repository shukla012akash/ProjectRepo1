...
{
    internal class ManageFoodCategory
    {
        string itemName;
        int itemId;
       
        // ADD ITEM
        public void AddItemToTheFoodCategory()
        {
            FileStream fileStreamObj = new FileStream(@"C:\Users\Boss\Desktop\New folder\category.txt", FileMode.Append, FileAccess.Write);
            StreamWriter swObj = new StreamWriter(fileStreamObj);
            int counter = 1, totalItem;
            Console.WriteLine("Enter total number Of Food Item you want to add in the Food Item Category");
        ...
        {
            FileStream fileStreamObj = new FileStream(@"C:\Users\Boss\Desktop\New folder\category.txt", FileMode.Open, FileAccess.Read);
            StreamReader streamReaderObj = new StreamReader(fileStreamObj);

            FileStream fileStreamWObj = new FileStream(@"C:\Users\Boss\Desktop\New folder\category.txt", FileMode.Append, FileAccess.Write);
            ...
            File.Move(@"C:\Users\Boss\Desktop\New folder\category.txt", @"C:\Users\Boss\Desktop\New folder\category.txt");
